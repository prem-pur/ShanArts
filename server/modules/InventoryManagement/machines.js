...
router.post('/', auth, roleCheck(['admin', 'staff_schedule']), machineController.addMachine);
router.delete('/:id', auth, roleCheck(['admin', 'staff_schedule']), machineController.deleteMachine);
router.put('/:id', auth, roleCheck(['admin', 'staff_schedule']), machineController.updateMachine);
router.patch('/:id/status', auth, roleCheck(['admin', 'staff_operator', 'staff_schedule']), machineController.updateMachineStatus);
router.patch('/:id/assign-operator', auth, roleCheck(['admin', 'staff_schedule']), machineController.assignOperator);
