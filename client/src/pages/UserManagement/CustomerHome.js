...
const CustomerHome = () => {
    ...
    const handleApproval = async (action) => {
        ...
        try {
            ...
            // productionOrder reference kept for future use
            productionOrderRes.data.find(po => po.shopOrderId === selectedOrder._id);
                        ...
                        <div style={{ background: '#fff', width: '100%', maxWidth: '700px', borderRadius: '24px', overflow: 'hidden', boxShadow: '0 25px 50px rgba(0,0,0,0.3)' }}>
                            ...
                            {showRejectionForm && (
                                <div style={{ margin: '0 32px 24px', padding: '24px', background: '#fff5f5', borderRadius: '16px', border: '1.5px solid #fca5a5' }}>
                                    <div style={{ fontWeight: '800', color: '#dc2626', fontSize: '13px', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '16px' }}>🚫 Rejection Details</div>
                            ...
                            {!showRejectionForm && (
                                <div style={{ padding: '0 32px 28px', display: 'flex', gap: '16px' }}>
                                    ...
                                    <button onClick={() => setShowRejectionForm(true)} style={{ flex: 1, padding: '14px', borderRadius: '12px', border: '1.5px solid #dc2626', background: '#fff', color: '#dc2626', fontWeight: '800', cursor: 'pointer' }}>🚫 REJECT</button>
